...
- (void)viewDidLoad
{
    ...
    self.service = [[APBeaconService alloc] initWithProximityUUID:[NSUUID UUID] major:[@"42" dataUsingEncoding:NSUTF8StringEncoding] minor:[@"21" dataUsingEncoding:NSUTF8StringEncoding]];
